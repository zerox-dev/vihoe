...
language_container_t language_russian = {
  L"Настроить HENkaku",
  L"Спуфинг PSN",
  L"Поддержка небезопасных приложений",
  L"Небезопасные приложения могут повредить ваше устройство, если они используются неправильно, неправильно настроены или вредоносны.\nПожалуйста, проявляйте осторожность при их установке. И скачивайте их только с надежных источников.",
  L"Подмена версии",
  L"Поддельная версия",
  L"Поведение кнопки 'круг'",
  L"Ввод (Подтверждение)",
  L"Отмена (Назад)",
  L"Перезагрузить taiHEN config.txt",
  L"taiHEN config.txt был успешно перезагружен.",
  L"Перезапустить консоль",
  ...
  L"Ошибка при монтировании ux0. Вставлена ли карта памяти?",
};
...
language_container_t language_english_gb = {
  L"HENkaku Settings",
  L"PSN spoofing",
  L"Unsafe Homebrew support",
  L"Unsafe homebrews can damage your device, if they are misused, misconfigured, or malicious.\nPlease take caution when installing them. And download them only from trusted sources!",
  L"Version Spoofing",
  L"Spoofed Version",
  L"'Circle' Button Behaviour",
  L"Enter (Click)",
  L"Cancel (Back)",
  L"Reload taiHEN config.txt",
  L"taiHEN config.txt has been successfully reloaded.",
